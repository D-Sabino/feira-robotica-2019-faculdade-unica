////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Arquivo: NodeMCU_acesso_local.ino
//Tipo: Codigo-fonte para utilizar no NodeMCU ESP8266
//Autor: Pedro Henrique Capriglione para o canal LabSemFio
//Descricao: Curso de ESP8266 - Controlando um Led pelo celular, PC, etc.
//Video:
////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
IPAddress ip(192, 168, 0, 1); //Gateway Padrão. Esse será o valor que vai ser digitado no browser
//IP do roteador da sua rede wifi
IPAddress gateway(192, 168, 0, 129); //Endereço IPv4
...
void loop() {
 ...
 buf += ".btn.btn-sea{background-color: #08bc9a; border-color: #08bc9a; -webkit-box-shadow: 0 3px 0 #088d74; boxshadow: 0 3px 0 #088d74;} ";
 ...
 buf += "<p align='center'><font size='10'>Controle de Led</font></p> ";
 buf += "</div> ";
 buf += "</div> ";
 buf += "<div class='row'> ";
 ...
 buf += "</div> ";
 buf += "<div class='col twelve'> ";
 buf += "<p align='center'><font size='5'>LabSemFio</font></p> ";
 buf += "</div> ";
 buf += "</div> ";
 buf += "</body> ";
 buf += "</html> ";
